...
function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center pt-24 overflow-hidden bg-gradient-to-br from-light to-[#f3f3f0]">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-8 order-2 lg:order-1">
          ...
          >
            ...
            <span className="text-sm font-medium tracking-widest text-text-medium uppercase">Кухни на заказ с 2010 года</span>
          </motion.div>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif leading-[1.1] text-primary">
...
function StylesSection() {
  ...
  return (
    <section className="py-24 bg-primary text-white overflow-hidden">
      ...
      <div 
        ref={scrollRef}
        className="flex gap-6 overflow-x-auto pb-8 px-4 container mx-auto snap-x snap-mandatory scrollbar-hide"
        style={{ scrollbarWidth: 'none' }}
      >
        {styles.map((style, i) => (
          <div key={i} className="min-w-[260px] md:min-w-[320px] aspect-[3/4] relative group rounded-2xl overflow-hidden snap-center flex-shrink-0 cursor-pointer">
            <img 
              src={style.img} 
              alt={style.title} 
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              ...
              <p className="text-white/70 text-sm mb-4">от {style.price} ₽/м.п.</p>
              <span className="inline-flex items-center text-accent text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity delay-100">
