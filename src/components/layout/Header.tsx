    ...
    <>
      <header
        className={cn(
          ...
          scrolled ? "bg-white/80 backdrop-blur-md py-3 shadow-sm border-white/20" : "bg-gradient-to-b from-black/70 to-transparent py-6"
        )}
      >
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
          <Link to="/" className="text-2xl font-serif font-bold tracking-tight group z-50 relative">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Button className="bg-accent text-white hover:bg-accent-hover shadow-lg shadow-accent/20">
              Рассчитать кухню
            </Button>
          </div>
          ...
          >
            <nav className="flex flex-col gap-6 items-center text-center">
              ...
              >
                ...
                <Button className="w-full text-lg h-14 bg-primary text-white">
                  Рассчитать проект
                </Button>
              </motion.div>
            </nav>
